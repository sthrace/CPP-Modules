...
{
	std::cout << BOLDMAGENTA << "A NoName ClapTrap has been created" << DEFAULT <<std::endl;
}

ClapTrap::ClapTrap(std::string const name) : m_name(name), m_hitpoints(10), m_epoints(10), m_damage(0)
{
	std::cout << BOLDMAGENTA << "ClapTrap " << m_name << " has been created" << DEFAULT << std::endl;
}
...
{
	std::cout << BOLDRED << "ClapTrap " << m_name << " died" << DEFAULT << std::endl;
}
